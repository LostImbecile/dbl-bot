...
public class ServerNotifyBothCommand implements Command {
	...
	public String getDescription() {
		return "Setup both join and leave notifications in a channel";
	}
	...
	public boolean execute(Message msg, String arguments) throws Exception {
		...
		if (arguments == null || arguments.trim().isEmpty()) {
			msg.getChannel().sendMessage("**Usage:** `" + getUsage() + "`\n" +
					"**Example:** `notify both here` or `notify both #general`");
			return true;
		}
		...
		ServerNotificationsFeature.enableLeaveNotifications(msg);
		msg.getChannel().sendMessage("✅ Both join and leave notifications enabled for <#" + targetChannel.getId() + ">");
