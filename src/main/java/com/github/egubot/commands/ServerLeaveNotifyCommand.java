...
public class ServerLeaveNotifyCommand implements Command {
	...
	public String getDescription() {
		return "Setup server leave notifications in a channel";
	}
	...
	public boolean execute(Message msg, String arguments) throws Exception {
		...
		if (arguments == null || arguments.trim().isEmpty()) {
			msg.getChannel().sendMessage("**Usage:** `" + getUsage() + "`\n" +
					"**Example:** `leave notify here` or `leave notify #general`");
			return true;
		}
		...
		msg.getChannel().sendMessage("✅ Leave notifications enabled for <#" + targetChannel.getId() + ">");
